...
/**
 * Totally wrong way to thing about this instance mode,
 * every instance should be its own canvas so...
 *    I will have to redo this entire folder of js files
 *    And think about p5 instance mode differently
 * IT works, its just disater
 */
export const p5tools = (p5) => {
  window.p5 = p5; // This needs to stay, cuz I dont know how to export this p5 variable

  p5.setup = () => {
    // p5.createCanvas(p5.windowWidth, p5.windowHeight);
    p5.createCanvas(10000,10000);
    window.canvas = document.getElementById("defaultCanvas0")
